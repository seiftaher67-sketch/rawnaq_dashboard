      ...
      <div className="page">
        <div className="top">
          <div className="title">
            ...
            <h1 className="text-2xl font-bold text-gray-800" style={{ marginLeft: '15px', marginBottom: '2px', fontFamily: 'Cairo', fontWeight: 600, fontStyle: 'SemiBold', fontSize: '36px', leadingTrim: 'NONE', lineHeight: '36px', letterSpacing: '0px', textAlign: 'right', color: '#101828' }}> تفاصيل المرتجع</h1>
            <p className="text-sm" style={{ marginLeft: '15px', marginTop: '20px', fontFamily: 'Cairo', fontWeight: 400, fontStyle: 'Regular', fontSize: '24px', leadingTrim: 'NONE', lineHeight: '24px', letterSpacing: '0px', textAlign: 'right', color: '#6A7282' }}> 2025-11-30 – #ORD-1246</p>
          </div>
        ...
        <div className="grid">
          ...
          <div>
            <div className="card" style={{ fontFamily: 'Cairo' }}>
              ...
              <h3>ملخص الطلب</h3>
              <div style={{ color: '#ef2525ff', fontWeight: 400, fontSize: '20px', lineHeight: '16px', whiteSpace: 'nowrap', textAlign: 'left', position: 'relative', top: '-43px', fontFamily: 'Cairo' }}> مرتجع</div>
              <div className="row"><span>المجموع الفرعي</span><span>SAR 1640</span></div>
              <div className="row green"><span>رسوم التوصيل</span><span  style={{ color: '#61da16ff' ,fontweight: 'bold' }}>مجاني</span></div>
              <div className="line" />
              <div className="row" style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}><strong>الإجمالي</strong><strong >SAR 1640</strong></div>
            </div>

            <div className="card" style={{ marginTop: 20, fontFamily: 'Cairo' }}>
              <h3>سبب الاسترجاع</h3>
