                ...
                <div className="account-page">
                    ...
                    <div className="account-layout">
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', marginLeft: '-200px' }}>
                            <div className="card">
                                <h3 style={{ marginTop: ' -10px' }}>حجوزات المرتجعات الحالية</h3>
                                <div className="form-grid">
                                    <div>
                                        <label>رقم الحجز</label>
                                        <input defaultValue="#67890" />
                                    </div>
                                    <div>
                                        <label>تاريخ الحجز</label>
                                        <input defaultValue="2023-11-01" />
                                    </div>
                                    <div>
                                        <label>حالة الحجز</label>
                                        <select><option>مؤكد</option></select>
                                    </div>
                                    <div>
                                        <label>المبلغ الإجمالي</label>
                                        <input defaultValue="1500 ريال" />
                                    </div>
                                </div>
                            ...
                            <div className="card">
                                <h3 style={{ marginTop: ' -10px' }}>تاريخ الحجوزات</h3>
                                <div className="form-grid">
                                    <div>
                                        <label>آخر حجز</label>
                                        <input defaultValue="#67889" />
                                    </div>
                                    <div>
                                        <label>تاريخ الإقامة</label>
                                        <input defaultValue="2023-10-15" />
                                    </div>
                                    <div>
                                        <label>الحالة</label>
                                    ...
                                    <div>
                                        <label>المبلغ</label>
                                        <input defaultValue="1200 ريال" />
                                    </div>
                                </div>
                                <button className="save-btn">عرض الحجوزات السابقة</button>
                            </div>
                        </div>
